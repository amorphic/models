...
// Mounting hole offset X
mounting_hole_offset_x=30;
// Mounting hole offset Y
mounting_hole_offset_y=30;

/* [Lid Holes] */
// Button hole diameter
button_hole_diameter=20;
// Switch hole length
switch_hole_length=26;
// Switch hole width
switch_hole_width=22;
...
module MountingHoles(){
        translate([mounting_hole_offset_x,mounting_hole_offset_y,0]){
            cylinder(h=10, d=mounting_hole_diameter, $fn=180, center=true);
        }
        translate([-mounting_hole_offset_x,mounting_hole_offset_y,0]){
            cylinder(h=10, d=mounting_hole_diameter, $fn=180, center=true);
        }
        ...
        cylinder(h=10, d=cable_hole_diameter, $fn=180, center=true);
